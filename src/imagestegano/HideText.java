...
try  
                {  
                    ...
                    PreparedStatement ps = con.prepareStatement("insert into Key(ImageKey) values('"+str+"')"); 
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt)
    { if(evt.getSource() == hideTextButton)
    { SaveData();}
    }
 ...
 Class.forName("com.mysql.jdbc.Driver");  
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/reg","root","root");  
                    PreparedStatement ps = con.prepareStatement("insert into Key(ImageKey) values('"+txt1+"')"); 
     ps.executeUpdate();
 
 JOptionPane.showMessageDialog(null, txt1+" Saved Successfully to Database");
 }
 catch (Exception ex) 
 {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (evt.getSource()==jButton1) // Back
                        {
                                    setVisible(false);
